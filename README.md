...
``` 
/home/username/project_folder_name/ 
├── refhg38/ # Reference genome files (fasta, dbsnp, etc.) 
├── file/
	├── fastq/ # Raw and merged FASTQ files 
	├── bam/ # Aligned BAM files 
	└── vcf/ # Final VCF files
```

### Reference Directory (`/refhg38`)
...
**Location:** `/home/username/project_folder_name/file/fastq`
...
### 2. Alignment (FASTQ → SAM)

**Location:** `/home/username/project_folder_name/file/bam`
...
# Set Paths
FASTQ_DIR=../fastq
REF_DIR=/home/username/project_folder_name/refhg38
...
**Location:** `/home/username/project_folder_name/file/vcf`
...
for sid in $SAMPLES
do
  echo "▶ bcftools norm: split multiallelic + indel normalization for ${sid}..."
